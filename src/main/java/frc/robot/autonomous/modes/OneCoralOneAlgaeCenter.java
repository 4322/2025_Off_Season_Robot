...
import frc.robot.commands.AlgaePrescoreAuto;
import frc.robot.commands.AlgaeScoreAuto;
...
public class OneCoralOneAlgaeCenter extends SequentialCommandGroup {
    public OneCoralOneAlgaeCenter(
        ...
        addCommands(
            new AutoPoseReset(drive, Robot.CenterStartToGulf.getStartingHolonomicPose().get().getTranslation()),
            ...
            new WaitUntilCommand(() -> superstructure.armAtSetpoint() && superstructure.elevatorAtSetpoint()),
