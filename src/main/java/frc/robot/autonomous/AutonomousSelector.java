...
public class AutonomousSelector {
  ...
  public AutonomousSelector(
    ...
    autonomousSelector.addOption("LEAVE", new Leave(drivePan, superstructure));
    autonomousSelector.addOption(
        "ONE_RIGATONI_TWO_MEATBALL_CENTER", new OneRigatoniTwoMeatballCenter(drivePan, superstructure));
    autonomousSelector.addOption(
        "ONE_RIGATONI_TWO_MEATBALL_LEFT", new OneRigatoniTwoMeatballLeft(drivePan, superstructure));
    autonomousSelector.addOption(
        "THREE_RIGATONI_LEFT",
        new ThreeRigatoniLeft(drivePan, superstructure, intakeSuperstructure, vision));
    autonomousSelector.addOption(
        "THREE_RIGATONI_RIGHT",
        new ThreeRigatoniRight(drivePan, superstructure, intakeSuperstructure, vision));
    autonomousSelector.addOption(
        "ONE_RIGATONI_ONE_MEATBALL_CENTER", new OneRigatoniOneMeatballCenter(drivePan, superstructure));
    autonomousSelector.addOption(
        "TWO_RIGATONI_ONE_MEATBALL_LEFT",
        new TwoRigatoniOneMeatballLeft(drivePan, superstructure, intakeSuperstructure, vision));
    autonomousSelector.addOption(
        "ONE_RIGATONI_ONE_MEATBALL_EJECT_CENTER",
        new OneRigatoniOneMeatballEjectCenter(drivePan, superstructure, intakeSuperstructure, vision));
  }
