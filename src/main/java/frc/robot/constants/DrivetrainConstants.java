...
public class DrivetrainConstants {
  ...
  private static final double turnAccelerationLimit = 0;
  private static final double turnDeaccelerationLimit = 0;
  private static final double turnVelocityLimit = 0;
  ...
  // Front Left
  private static final int frontLeftDriveMotorId = 0;
  private static final int frontLeftTurnMotorId = 0;
  private static final int frontLeftTurnEncoderId = 0;

  private static final double frontLeftXPos = 0;
  private static final double frontLeftYPos = 0;

  // Front Right
  private static final int frontRightDriveMotorId = 0;
  private static final int frontRightTurnMotorId = 0;
  private static final int frontRightTurnEncoderId = 0;

  private static final double frontRightXPos = 0;
  private static final double frontRightYPos = 0;

  // Back Left
  private static final int backLeftDriveMotorId = 0;
  private static final int backLeftTurnMotorId = 0;
  private static final int backLeftTurnEncoderId = 0;

  private static final double backLeftXPos = 0;
  private static final double backLeftYPos = 0;

  // Back Right
  private static final int backRightDriveMotorId = 0;
  private static final int backRightTurnMotorId = 0;
  private static final int backRightTurnEncoderId = 0;

  private static final double backRightXPos = 0;
  private static final double backRightYPos = 0;
  ...
  private static final SwerveModuleConstantsFactory moduleCreator =
      new SwerveModuleConstantsFactory()
          ...
          .withTurnMotorGains(drivePIDSettings)
