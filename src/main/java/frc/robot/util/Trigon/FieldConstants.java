...
import frc.robot.util.Trigon.flippable.FlippablePose2d;
import java.io.IOException;
import java.util.HashMap;
import java.util.List;

public class FieldConstants {
  public static final double FIELD_WIDTH_METERS = FlippingUtil.fieldSizeY,
      FIELD_LENGTH_METERS = FlippingUtil.fieldSizeX;
  private static final List<Integer> I_HATE_YOU = List.of(13, 12, 16, 15, 14, 4, 5, 3, 2, 1);
  ...
  public static final FlippablePose2d AUTO_FIND_CORAL_POSE_LEFT =
      new FlippablePose2d(3.3, 5.5, Rotation2d.fromDegrees(130), true);
  public static final FlippablePose2d AUTO_FIND_CORAL_POSE_RIGHT =
      new FlippablePose2d(
          3.3, FieldConstants.FIELD_WIDTH_METERS - 5.5, Rotation2d.fromDegrees(-130), true);

  public static final int REEF_CLOCK_POSITIONS = 6;
  public static final Rotation2d REEF_CLOCK_POSITION_DIFFERENCE =
      Rotation2d.fromDegrees(Conversions.DEGREES_PER_ROTATIONS / REEF_CLOCK_POSITIONS);
  public static final Rotation2d[] REEF_CLOCK_ANGLES = ReefClockPosition.getClockAngles();
  public static final Translation2d BLUE_REEF_CENTER_TRANSLATION =
      new Translation2d(4.48945, FIELD_WIDTH_METERS / 2);
  public static final double REEF_CENTER_TO_TARGET_SCORING_POSITION_X_TRANSFORM_METERS = 1.3,
  ...
  public enum ReefSide {
    ...
    public boolean shouldFlipYTransform(ReefClockPosition reefClockPosition) {
      return doesFlipYTransformWhenFacingDriverStation
          ^ reefClockPosition
              .isFacingDriverStation; // In Java, ^ acts as an XOR (exclusive OR) operator, which
      // fits in this case
    }
  }
